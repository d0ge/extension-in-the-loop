 ...
 * that are identified.
 *
 * @deprecated New scan checks should instead implement {@link burp.api.montoya.scanner.scancheck.ActiveScanCheck} or {@link burp.api.montoya.scanner.scancheck.PassiveScanCheck}.
 */
@Deprecated
